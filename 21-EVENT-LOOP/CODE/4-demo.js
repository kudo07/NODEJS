...
setTimeout(() => {
  ...
  Promise.resolve().then(() => console.log('Promise 2')); // this cb will come before the last timer as the this settimeout cb will dirst execute the microtaks queue task
